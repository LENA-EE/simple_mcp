...
### Анализ папки с проектом
```
Разберись с Perl проектом в папке /project/lib/
Найди все проблемы и объясни их простым языком
```

### Аудит перед рефакто��ингом
```
Проведи аудит всего Perl кода в директории /src/
Сгруппируй проблемы по типам и предложи порядок исправления
```

### Проверка одного файла
```
Проанализируй файл script.pl через perlcritic
```

### Конкретная проверка стиля кода
```
Проверь Perl код на соблюдение стандартов кодирования
```